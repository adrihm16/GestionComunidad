            ...
            <div class="flex-1">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-muted flex-shrink-0" fill="none"
                    ...
                    @if($user->cargo_comunidad)
                        <div class="flex items-center gap-3">
                            ...
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold bg-amber-100 text-amber-700">
                    ...
                    {{-- IBAN (Private) --}}
                    @if(auth()->user()->rol_sistema === 'admin' || auth()->id() === $user->id)
                        @if($user->iban)
                            <div class="flex items-center gap-3 pt-2 border-t border-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-emerald-600 flex-shrink-0" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <div>
                                    <p class="text-[10px] uppercase tracking-wider font-bold text-emerald-600">IBAN PRIVADO</p>
                                    <p class="text-sm text-main font-mono">{{ $user->iban }}</p>
                                </div>
                            </div>
                        @endif
                    @endif
