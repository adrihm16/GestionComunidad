...
@section('title', 'Reportar Incidencia - Gestión Comunidad')
...
<div class="flex flex-col gap-5">
    ...
    {{-- Page Title --}}
    @include('components.ui.section-title', ['title' => 'Reportar incidencia', 'titleClass' => 'text-xl'])

    {{-- Form Card --}}
    @component('components.ui.card', ['hover' => false])
        <form action="{{ route('incidencias.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
            @csrf
            ...
            {{-- Descripción --}}
            <div class="flex flex-col gap-1.5">
                <label for="descripcion" class="text-sm font-medium text-main">
                ...
                <textarea
                    ...
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-main
                           ...
                           focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary
                           transition-all duration-200
                           @error('descripcion') border-red-400 ring-2 ring-red-100 @enderror"
            ...
            {{-- Prioridad --}}
            <div class="flex flex-col gap-1.5">
                <label for="prioridad" class="text-sm font-medium text-main">
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-sm font-medium text-main">
                    Foto <span class="text-xs text-muted font-normal">(opcional)</span>
                </label>

                {{-- Upload area --}}
                <div id="upload-area"
                     class="relative w-full border-2 border-dashed border-gray-200 rounded-xl
                    ...
                    <div id="upload-placeholder" class="flex flex-col items-center justify-center py-8 px-4">
                        ...
                        <p class="text-sm font-medium text-main mb-0.5">Adjuntar foto</p>
                ...
                <div id="preview-container" class="hidden relative">
                    <img id="preview-image" src="" alt="Preview" class="w-full h-48 object-cover rounded-xl border border-gray-100">
                    <button type="button" onclick="removeImage()"
                            class="absolute top-2 right-2 flex items-center justify-center w-8 h-8 rounded-full
            ...
            <button
                type="submit"
                class="w-full py-3 rounded-xl bg-primary text-white text-sm font-semibold
