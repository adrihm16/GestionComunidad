...
@section('content')
    <div class="flex flex-col gap-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('incidencias.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-primary text-white text-sm font-medium shadow-md
        ...
        <div class="flex flex-col gap-4">
            ...
            @empty
                <div class="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <a href="{{ route('incidencias.index') }}" class="mt-2 text-primary text-sm font-medium hover:underline">
                        Reportar la primera
                    </a>
                </div>
            @endforelse
