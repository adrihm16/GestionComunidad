...
<div x-show="{{ $open }}" 
    ...
    <div @click.away="{{ $open }} = false"
        ...
        <div class="p-6 overflow-y-auto">
            <form action="{{ route('admin.recibos.store') }}" method="POST" id="createReciboForm" class="flex flex-col gap-4">
                @csrf
                {{-- Property Selector --}}
                <div>
                ...
                <div class="p-3 bg-blue-50 text-blue-800 text-xs rounded-lg">
                    <span class="font-bold">Nota:</span> Se generarán automáticamente recibos para los meses restantes del año actual.
                </div>
