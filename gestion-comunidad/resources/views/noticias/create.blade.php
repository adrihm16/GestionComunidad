...
@section('title', 'Publicar Noticia - Gestión Comunidad')
...
<div class="flex flex-col gap-5">
    ...
    {{-- Page Title --}}
    @include('components.ui.section-title', ['title' => 'Publicar noticia', 'titleClass' => 'text-xl'])

    {{-- Form Card --}}
    @component('components.ui.card', ['hover' => false])
        <form action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
            @csrf
