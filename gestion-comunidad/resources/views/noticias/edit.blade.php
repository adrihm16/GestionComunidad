...
@section('title', 'Editar Noticia - Gestión Comunidad')

@section('content')
<div class="flex flex-col gap-5">

    {{-- Back button --}}
    <a href="{{ route('noticias.index') }}" class="inline-flex items-center gap-2 text-sm font-medium text-muted hover:text-primary transition-colors w-fit">
    ...
    @component('components.ui.card', ['hover' => false])
        <form action="{{ route('noticias.update', $noticia) }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input
                    ...
                    placeholder="Ej: Nueva normativa de reciclaje en la comunidad"
                    required
                    maxlength="150"
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea
                    ...
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-main
                           ...
                           focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary
                           transition-all duration-200
                           @error('contenido') border-red-400 ring-2 ring-red-100 @enderror"
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-sm font-medium text-main">
                    {{ $noticia->adjunto_url ? 'Nueva imagen' : 'Imagen' }} <span class="text-xs text-muted font-normal">(opcional)</span>
                </label>
