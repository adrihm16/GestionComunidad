        ...
        <div class="flex items-center justify-between">
            ...
            @if(auth()->check() && auth()->user()->rol_sistema === 'admin')
                <div class="flex items-center gap-2">
                    {{-- Edit button --}}
                    <a href="{{ route('admin.dashboard') }}?edit_noticia={{ $noticia->id }}" class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-500 text-white text-xs font-medium
